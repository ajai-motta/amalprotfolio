...
export default function Education() {
  ...
  return (
    <section id="education" className="py-20 bg-zinc-50/70 dark:bg-[#060608] relative border-t border-zinc-200 dark:border-zinc-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-3xl sm:text-4xl font-serif font-black tracking-[0.14em] text-zinc-900 dark:text-zinc-100 uppercase"
          >
            EDUCATION
          </motion.h2>
        </div>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {educationList.map((item, idx) => (
            <motion.div
              ...
              className="p-6 rounded-md bg-white dark:bg-[#0d0d12] border border-zinc-200 dark:border-zinc-800/80 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors flex flex-col justify-between shadow-md dark:shadow-none"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="px-2.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-[11px] font-mono text-amber-600 dark:text-amber-400">
                    {item.period}
                  </span>
              ...
              <div className="mt-6 pt-4 border-t border-zinc-200 dark:border-zinc-800/60 flex items-center gap-2 text-[11px] font-mono text-zinc-500">
