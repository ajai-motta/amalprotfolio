    ...
    <section id="about" className="py-24 bg-[#07070a] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative aspect-[4/5] w-full rounded-lg overflow-hidden border border-zinc-800 bg-zinc-950 shadow-2xl group">
              <Image
                src="/images/amal_portrait.svg"
              ...
              {/* Bottom Card Slate */}
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded bg-zinc-950/85 backdrop-blur-md border border-zinc-800 flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-mono tracking-widest text-zinc-500 uppercase block">ARTIST IDENTITY</span>
                  <span className="font-serif font-bold text-sm text-zinc-100 tracking-wider">AMAL B MATHEW</span>
                </div>
                <div className="text-right">
                  <span className="text-[10px] font-mono tracking-widest text-zinc-500 uppercase block">LOCATION</span>
                  <span className="text-xs font-mono text-amber-400">Kerala, India</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-[11px] font-mono tracking-[0.25em] text-amber-400 uppercase mb-4 self-start">
              <User className="w-3.5 h-3.5" />
              <span>ARTIST PHILOSOPHY</span>
            </div>

            <h2 className="text-3xl sm:text-5xl font-serif font-black tracking-[0.12em] text-zinc-100 uppercase mb-6">
              ABOUT ME
            </h2>
            ...
            <div className="space-y-4 text-zinc-300 text-base sm:text-lg leading-relaxed font-light">
              <p className="border-l-2 border-amber-400/80 pl-4 py-1 italic text-zinc-200">
            ...
            <div className="mt-8 pt-8 border-t border-zinc-800/80">
              <h3 className="text-xs font-mono uppercase tracking-[0.25em] text-zinc-400 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {qualities.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="p-3 rounded bg-zinc-900/50 border border-zinc-800/70 hover:border-zinc-700 transition-colors"
                    >
